...
public class TelefonBuchEinfuegenPanel
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == buttonEinfuegen) {
            boolean i = telBuch.insert(tfEinfuegenName.getText(), tfEinfuegenZusatz.getText(), tfEinfuegenTelNr.getText());
            if (i == false) {
                JOptionPane.showMessageDialog(this, "Name bereits vorhanden");
            }
        }
